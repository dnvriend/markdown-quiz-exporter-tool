---
name: skill-markdown-quiz-exporter
description: A CLI tool that exports the quiz-markdown-format to tools like Anki, Flashcard Hero
---
...
- When you need to use markdown-quiz-exporter CLI tool
- When you need comprehensive guidance on CLI commands
- When you need examples and troubleshooting

# markdown-quiz-exporter Skill

## Purpose

<!-- TODO: Expand with specific tool capabilities -->
This skill provides access to the `markdown-quiz-exporter` CLI tool. A CLI tool that exports the quiz-markdown-format to tools like Anki, Flashcard Hero.

## When to Use This Skill

**Use this skill when:**
<!-- TODO: Add specific scenarios, e.g., -->
- You need to understand how to use markdown-quiz-exporter
- You need comprehensive examples and patterns
- You need troubleshooting guidance

**Do NOT use this skill for:**
<!-- TODO: Add anti-patterns, e.g., -->
- Tasks unrelated to markdown-quiz-exporter
- Quick syntax lookups (use slash commands instead)

## CLI Tool: markdown-quiz-exporter

<!-- TODO: Add tool overview -->
The `markdown-quiz-exporter` is a command-line interface tool that A CLI tool that exports the quiz-markdown-format to tools like Anki, Flashcard Hero.
...
**Usage:**
```bash
markdown-quiz-exporter command-name ARGUMENT [OPTIONS]
```
...
```bash
# Example 1: Basic usage
markdown-quiz-exporter command-name "example"

# Example 2: With options
markdown-quiz-exporter command-name "example" --option value

# Example 3: Pipeline usage
markdown-quiz-exporter command-name "example" --json | jq '.'
```
...
```bash
markdown-quiz-exporter --help
markdown-quiz-exporter COMMAND --help
```
...
markdown-quiz-exporter command -v

# DEBUG level - see detailed info
markdown-quiz-exporter command -vv

# TRACE level - see all internals
markdown-quiz-exporter command -vvv
```
...
markdown-quiz-exporter command --json | jq '.'
```
...
- **GitHub**: https://github.com/dnvriend/markdown-quiz-exporter
- **Python Package Index**: https://pypi.org/project/markdown-quiz-exporter/
