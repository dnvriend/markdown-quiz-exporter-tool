...
- **Slash Commands**: Quick CLI invocations (e.g., `/markdown-quiz-exporter:help`)
- **Skills**: Comprehensive documentation with progressive disclosure (e.g., `/skill-markdown-quiz-exporter`)
...
**File**: `plugins/markdown-quiz-exporter/.claude-plugin/plugin.json`
...
**Location**: `plugins/markdown-quiz-exporter/commands/`
...
**Adding New Commands**:
1. Create `plugins/markdown-quiz-exporter/commands/<command>.md`
...
/markdown-quiz-exporter:command "argument"
```

## Skills

**Location**: `plugins/markdown-quiz-exporter/skills/markdown-quiz-exporter/SKILL.md`
...
**Usage in Claude Code**:
```
/skill-markdown-quiz-exporter
```

Or:
```
Use the skill-markdown-quiz-exporter to help me understand this tool
```
...
1. **Update the slash command** (optional):
   - Create `plugins/markdown-quiz-exporter/commands/<command>.md`
...
3. `plugins/markdown-quiz-exporter/.claude-plugin/plugin.json` → `version`
...
# Check plugin
cat plugins/markdown-quiz-exporter/.claude-plugin/plugin.json | jq '.'

# List commands
ls plugins/markdown-quiz-exporter/commands/

# Check skill
cat plugins/markdown-quiz-exporter/skills/markdown-quiz-exporter/SKILL.md
```

### Test in Claude Code
1. Open your project in Claude Code
2. Try slash command: `/markdown-quiz-exporter:help`
3. Try skill: `/skill-markdown-quiz-exporter`
